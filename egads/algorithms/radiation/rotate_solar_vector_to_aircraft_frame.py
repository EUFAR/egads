...
class RotateSolarVectorToAircraftFrame(egads_core.EgadsAlgorithm):
    ...
    def __init__(self, return_Egads=True):
        ...
        self.metadata = egads_metadata.AlgorithmMetadata({'Inputs':['theta_sun', 'phi_sun', 'roll', 'pitch', 'roll'],
                                                          ...
                                                          'InputDescription':['Solar zenith','Solar azimuth (mathematic negative, north=0 deg)','Aircraft roll (mathematic positive, left wing up=positive)','Aircraft pitch (mathematic positive, nose down=positive)','Aircraft yaw (mathematic negative, north=0 deg)'],
