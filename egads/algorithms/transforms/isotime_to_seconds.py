...
class IsotimeToSeconds(egads_core.EgadsAlgorithm):
    ...
    DESCRIPTION Calculates seconds elapsed from a series of ISO 8601 date/time strings
                using the Python dateutil and datetime modules.

    INPUT       t_ISO         vector                ISO 8601 strings
                t_ISO_ref     string, optional      Reference time (ISO 8601 string) - default
                                                    is 19700101T000000
                format        string, optional      Time string format - if none provided
                                                    algorithm will attempt to automatically
                                                    deconstruct timestring
