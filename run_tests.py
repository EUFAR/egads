...
try:
    ...
    logging.error('Error: Numpy installation not found. You must install Numpy before EGADS can be used. See INSTALL.txt for more info.')
else:
...
try:
    ...
    logging.error('Error: Scipy installation not found. You must install Scipy before EGADS can be used. See INSTALL.txt for more info.')
else:
...
try:
    ...
    logging.error('Error: netCDF4 installation not found. You must install the netCDF4 library before using EGADS. See INSTALL.txt for more info.')
else:
...
try:
    ...
    logging.error('Error: nappy module not found. Nappy should be included in the thirdparty directory of EGADS. Please correct that issue before using EGADS')
...
try:
    ...
    logging.error('Error: quantities module not found. Quantities should be included in the thirdparty directory of EGADS. Please correct that issue before using EGADS')
